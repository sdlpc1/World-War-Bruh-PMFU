...
NDefines.NAir.NAVAL_STRIKE_CARRIER_MULTIPLIER = 2.0 --was 2.5 but i increased overall naval damage        -- damage bonus when planes are in naval combat where their carrier is present (and can thus sortie faster and more effectively)	
...
NDefines.NAir.AIR_WING_BOMB_DAMAGE_FACTOR = 10 --controlls strat bombing damage was too strong on 5 but might need to be high to actually damage something
...
NDefines.NAir.COMBAT_DAMAGE_SCALE = 0.12			--0.11 prev			-- Vanilla 0,10
...
NDefines.NMilitary.ENEMY_AIR_SUPERIORITY_SPEED_IMPACT = -0.10   --Vanilla 0.3
NDefines.NMilitary.ENEMY_AIR_SUPERIORITY_IMPACT = -0.30          --Vanilla -0.35 
NDefines.NMilitary.ENEMY_AIR_SUPERIORITY_DEFENSE_STEEPNESS = 90 --see plot in mod/resources
